    ...
    <div className='relative h-full'>
      <div>
        <div className='w-full relative'>
          <Navbar />
          <div className='flex justify-center items-center w-full   mb-8 md:mb-16'>
            <div className='flex flex-col md:flex-row justify-between items-center w-full max-w-screen-xl px-4 md:px-0r'>
              <div className=' flex flex-col pt-8 md:pt-0 md:w-1/4'>
                ...
                <div className='mt-3'>
                  ...
                  <div className='w-[250px] grid grid-cols-4 gap-5'>
                    ...
                    <button className=' hover:bg-[#ED165F]  w-[60px] border-2 rounded border-[#555] uppercase '>xs</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>s</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>m</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>l</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase  bg-[#ED165F]'>xl</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>23</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>24</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>25</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>26</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>27</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>28</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>28</button>
                    <button className='hover: g-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>29</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase '>30</button>
                    <button className=' hover:bg-[#ED165F] w-[60px] border-2 rounded border-[#555] uppercase  bg-[#ED165F]'>31</button>
                  </div>
                </div>
              ...
              <div className='w-[70%]'>
                ...
                <div className='text-center mx-auto flex flex-col items-center pt-[300px]'>
                  ...
                  <div className="flex gap-5 justify-center items-center">
                    <button className='w-12 h-8 cursor-pointer border-b-2 border-red-500 my-2 mx-2' disabled={disPrev} onClick={prev} >1</button>
                    <button className='w-12 h-8 cursor-pointer border-b-2 border-red-500 my-2 mx-2' disabled={disNext} onClick={next}>2</button>
